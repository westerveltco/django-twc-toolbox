...
- Support for using django-tables2 with `django_twc_toolbox.crud.CRUDView`. The view now has the option to set a `table_class` and `table_data` class attributes that, if set, will render the table on the list page using django-tables2.
